// website/src/lib/hebcal-slug.ts
//
// MIRRORED FROM dashboard/src/lib/hebcal-slug.ts. The two files MUST stay
// byte-identical except for this header — any divergence reintroduces the
// "Korach instead of Beha'alotcha" bug class (incident: 2026-06-01).
// A CI grep in .github/workflows/pr-check.yml fails the build if they diverge.
